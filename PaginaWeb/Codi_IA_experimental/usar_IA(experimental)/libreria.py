# es una IA de internet NO ES MIA !!!!!!!!!!!
...
class Detector:
    ...
    def loadModel(self):
        ...
        print("Model"+self.modelName + " loaded sucsesfuly..." )
    ...
    def createBoundigBox(self, image, threshold = 0.5):
        ...
        if len(bboxsIdx) != 0:
            for i in bboxsIdx:
                ...
                cv2.putText(image, displayText, (xmin, ymin-10), cv2.FONT_HERSEY_PLAIN, 1, classColor, 2)
